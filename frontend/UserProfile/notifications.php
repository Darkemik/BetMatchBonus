        ...
        <div class="row">
            <div class="col-md-3">
                <nav class="profile-sidebar">
                    ...
                    <a href="notifications.php" class="profile-nav-item active"><i class="fas fa-bell"></i> <span>Értesítések</span><?php if ($unreadCount > 0): ?> <span class="notif-badge-sidebar"><?= $unreadCount ?></span><?php endif; ?></a>
